...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['CheemsAndFriends',	'face',	'Creator of FlxAnimate\n(TODO: Add Icon)',	 'https://twitter.com/CheemsnFriendos',	'A1A1A1'],
			[''],
			["Funkin' Crew"],
			['ninjamuffin99',		'ninjamuffin99',	"Programmer of Friday Night Funkin'",						 'https://twitter.com/ninja_muffin99',	'CF2D2D'],
			['PhantomArcade',		'phantomarcade',	"Animator (& Director) of\nFriday Night Funkin'",							 'https://twitter.com/PhantomArcade3K',	'FADC45'],
			['EliteMasterEric',		'mastereric',		"Additional Programmer of\nFriday Night Funkin'",									 'https://twitter.com/EliteMasterEric',	'FFBD40'],
