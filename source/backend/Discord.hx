...
class DiscordClient
{
	...
	public static function changePresence(details:String = 'Starting', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
